...
export default async function AdminDashboard() {
  ...
  return (
    <div className="space-y-6 lg:space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold text-white">Табло</h1>
        <p className="text-text-secondary mt-1 sm:mt-2 text-sm sm:text-base">Добре дошли в администраторския панел</p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
        <div className="bg-background-secondary p-4 sm:p-6 rounded-lg border border-gray-800">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-text-secondary text-xs sm:text-sm">Продукти</p>
        ...
        <div className="bg-background-secondary p-4 sm:p-6 rounded-lg border border-gray-800">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-text-secondary text-xs sm:text-sm">Категории</p>
        ...
        <div className="bg-background-secondary p-4 sm:p-6 rounded-lg border border-gray-800">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-text-secondary text-xs sm:text-sm">Поръчки</p>
        ...
        <div className="bg-background-secondary p-4 sm:p-6 rounded-lg border border-gray-800">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-text-secondary text-xs sm:text-sm">Потребители</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
        <div className="bg-background-secondary p-4 sm:p-6 rounded-lg border border-gray-800">
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <h3 className="text-base sm:text-lg font-semibold text-white">Общи приходи</h3>
          ...
          <p className="text-text-secondary text-xs sm:text-sm mt-1 sm:mt-2">Приходи за цялото време</p>
        </div>

        <div className="bg-background-secondary p-4 sm:p-6 rounded-lg border border-gray-800">
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <h3 className="text-base sm:text-lg font-semibold text-white">Месечен ръст</h3>
          ...
          <p className="text-text-secondary text-xs sm:text-sm mt-1 sm:mt-2">Спрямо миналия месец</p>
        </div>
      </div>
          ...
          <div className="p-4 sm:p-6">
            {lowStockProducts.length === 0 ? (
              <div className="text-center py-4 sm:py-6">
                ...
                <p className="text-green-400 font-medium text-sm sm:text-base">Всички продукти са добре заредени!</p>
              </div>
            ) : (
        ...
        <div className="bg-background-secondary rounded-lg border border-gray-800">
          <div className="p-4 sm:p-6 border-b border-gray-800 flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-white">Чакащи поръчки</h3>
            </div>
          ...
          <div className="p-4 sm:p-6">
            {pendingOrders.length === 0 ? (
              <div className="text-center py-4 sm:py-6">
                ...
                <p className="text-green-400 font-medium text-sm sm:text-base">Всички поръчки са обработени!</p>
              </div>
            ) : (
              <div className="space-y-2 sm:space-y-3 max-h-64 overflow-y-auto">
      ...
      <div className="bg-background-secondary rounded-lg border border-gray-800">
        <div className="p-4 sm:p-6 border-b border-gray-800">
          <h3 className="text-base sm:text-lg font-semibold text-white">Скорошни продукти</h3>
        </div>
        <div className="p-4 sm:p-6">
              ...
              <div key={product.id} className="flex items-center justify-between py-2 sm:py-3 border-b border-gray-800 last:border-b-0">
                ...
                <div className="text-right flex-shrink-0 ml-2">
                  ...
                  <p className="text-text-secondary text-xs sm:text-sm">
                    {product.featured ? 'Препоръчан' : 'Стандартен'}
                  </p>
                </div>
              </div>
            ))}
