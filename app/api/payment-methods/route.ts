...
const logger = createLogger('api:payment-methods');
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    logger.error('Error fetching payment methods', { error: getSafeErrorDetails(error) });
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    logger.error('Error creating payment method', { error: getSafeErrorDetails(error) });
